"""
run_libero_eval_reason_vla_projector_crossattn_patched.py

LIBERO-PRO eval for ReasonVLAProjectorCrossAttn.

How it works:
  - Pass --task_suite_name with the base suite (e.g., libero_spatial)
  - Pass --evaluation_config_path pointing to an evaluation_config.yaml
...
def main():
    parser = argparse.ArgumentParser(description="LIBERO-PRO eval for ReasonVLAProjectorCrossAttn")
