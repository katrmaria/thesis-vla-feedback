"""
run_libero_eval_reason_vla_multilayer.py

Runs the ReasonVLA Multi-Layer model (from reason_vla_multilayer.py) in a LIBERO simulation environment.
Original LIBERO evaluation only (no perturbation support).

Usage:
    python run_libero_eval_reason_vla_multilayer.py \
...
# Import ReasonVLA from reason_vla_multilayer.py (Multi-Layer variant)
...
def main():
    parser = argparse.ArgumentParser(description="LIBERO eval for ReasonVLA Multi-Layer (original LIBERO)")
